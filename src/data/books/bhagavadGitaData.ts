export const bhagavadGitaData = {
  ...
  title: "Bhagavad Gita",
  author: "Sri Krishna",
  image: require("@/assets/images/categories/bhagavad-gita.jpeg"), // Adjust path as needed
  rating: 4.8,
  language: "Sanskrit",
  chapters: [
    {
      ...
      verseCount: 1, // Update if more verses are added
      verses: [
        {
          id: "1.1",
          verse: 1,
...
māmakāḥ pāṇḍavāśhchaiva kimakurvata sañjaya`,
          ...
          audioUrl: require("@/assets/sounds/bg_2.mp3") // Adjust path as needed
        },
        {
          id: "1.2",
          verse: 2,
        ...
        },
        {
          ...
          translation: "Here in this army are many heroic bowmen equal in fighting to Bhima and Arjuna; great warriors like Yuyudhana (Satyaki), Virata, and Drupada, the mighty charioteer.",
          commentary: "This verse is part of Sanjaya’s narration to King Dhritarashtra, describing the formidable warriors aligned with the Pandavas. Duryodhana, feeling uneasy, lists powerful heroes who are as skilled and strong as Bhima and Arjuna. 'Heroic bowmen' (śūrā maheṣvāsāḥ) implies exceptional archers. Yuyudhana (Satyaki) was a valiant Yadava warrior and Arjuna's disciple. Virata was the king of Matsya who sheltered the Pandavas during exile. Drupada, king of Panchala and father of Draupadi, was also a powerful ally. Each is called a 'mahāratha'—a warrior capable of fighting thousands single-handedly.",
          audioUrl: require("@/assets/sounds/bg_2.mp3")
        },
        {
          id: "1.5",
          ...
          translation: "Also there are the mighty Dhrishtaketu, Chekitana, the valiant king of Kashi, Purujit, Kuntibhoja, and Shaibya—the best of men.",
          commentary: "This verse continues Duryodhana’s listing of the formidable Pandava allies. He highlights their strength to underscore the threat they pose to the Kaurava army. Dhrishtaketu, the king of Chedi and son of Shishupala, is a powerful warrior. Chekitana, a brave Yadava fighter and associate of Krishna, is also present. The king of Kashi (Varanasi) is praised for his valor. Purujit and Kuntibhoja are relatives and loyal supporters of the Pandavas. Shaibya, ruler of the Shibis, is known for his noble character and strength. The phrase 'nara-puṅgavaḥ' (the best among men) honors their superior warrior status.",
          audioUrl: require("@/assets/sounds/bg_2.mp3")
        }
